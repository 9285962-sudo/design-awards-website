...
const strategyData = [
  { id: 3, title: '国际设计奖评审标准深度解析', date: '2026-03-10', category: '评审解读', excerpt: '揭秘国际评委的评审视角，了解他们真正看重的设计价值。' },
  { id: 6, title: '建筑类设计作品的国际获奖之道', date: '2026-01-30', category: '行业专题', excerpt: '针对建筑设计作品的特点，分析如何在国际舞台上脱颖而出。' },
]

export default function StrategyJudging() {
  return (
    <>
      <Head>
        <title>获奖技巧 | 设计能</title>
        <meta name="description" content="国际设计大奖获奖技巧，提高获奖概率的实用方法。" />
      </Head>
      ...
      <main>
        <section style={styles.hero}>
          <div style={styles.container}>
            <div style={styles.breadcrumb}><Link href="/strategy" style={styles.breadLink}>参赛策略</Link> / 参赛成长</div>
            <h1 style={styles.heroTitle}>参赛成长</h1>
            <p style={styles.heroDesc}>提高获奖概率的实用方法与技巧</p>
          </div>
        </section>
        ...
        <section style={styles.section}>
          <div style={styles.container}>
            <div style={styles.categories}>
              ...
              <Link href="/strategy/growth" style={styles.categoryActive}>参赛成长</Link>
            </div>

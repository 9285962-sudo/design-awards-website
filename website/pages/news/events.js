...
// 筛选赛事动态类文章
const newsData = newsDataJson.articles.filter(a => a.category === '赛事动态')

export default function NewsEvents() {
  return (
    <>
      <Head>
        <title>赛事动态 | 设计能</title>
        <meta name="description" content="国际设计大奖赛事动态、规则变化、评委阵容等。" />
      </Head>
      ...
      <main>
        <section style={styles.hero}>
          <div style={styles.container}>
            <div style={styles.breadcrumb}><Link href="/news" style={styles.breadLink}>赛事新闻</Link> / 赛事动态</div>
            <h1 style={styles.heroTitle}>赛事动态</h1>
            <p style={styles.heroDesc}>国际设计大奖规则变化、评委阵容等动态</p>
          </div>
        </section>
        ...
        <section style={styles.section}>
          <div style={styles.container}>
            <div style={styles.categories}>
              ...
              <Link href="/news/events" style={styles.categoryActive}>赛事动态</Link>
            </div>

...
// 筛选报名通知类文章
const newsData = newsDataJson.articles.filter(a => a.category === '报名通知')

export default function NewsNotice() {
  return (
    <>
      <Head>
        <title>报名通知 | 设计能</title>
        <meta name="description" content="国际设计大奖报名通知、截止日期提醒。" />
      </Head>
      ...
      <main>
        <section style={styles.hero}>
          <div style={styles.container}>
            <div style={styles.breadcrumb}><Link href="/news" style={styles.breadLink}>赛事新闻</Link> / 报名通知</div>
            <h1 style={styles.heroTitle}>报名通知</h1>
            <p style={styles.heroDesc}>国际设计大奖报名截止日期提醒</p>
          </div>
        </section>
        ...
        <section style={styles.section}>
          <div style={styles.container}>
            <div style={styles.categories}>
              ...
              <Link href="/news/notice" style={styles.categoryActive}>报名通知</Link>
